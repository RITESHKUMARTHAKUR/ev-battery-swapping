...
describe('Asset Transfer Basic Tests', () => {
    ...
    describe('Test CreateAsset', () => {
        it('should return error on CreateAsset', async () => {
            ...
            let assetTransfer = new AssetTransfer();
            try {
                await assetTransfer.CreateAsset(transactionContext, asset.ID, asset.Manufacturer, asset.SOH, asset.Owner, asset.AppraisedValue);
    ...
    describe('Test UpdateAsset', () => {
        it('should return error on UpdateAsset', async () => {
            ...
            try {
                await assetTransfer.UpdateAsset(transactionContext, 'asset2', 'Amara', 90, 'Meena', 50);
        ...
        it('should return success on UpdateAsset', async () => {
            ...
            await assetTransfer.UpdateAsset(transactionContext, 'asset1', 'Exide', 90, 'Ada', 500);
            let ret = JSON.parse(await chaincodeStub.getState(asset.ID));
            let expected = {
                ID: 'asset1',
                Manufacturer: 'Exide',
    ...
    describe('Test GetAllAssets', () => {
        it('should return success on GetAllAssets', async () => {
            ...
            await assetTransfer.CreateAsset(transactionContext, 'asset1', 'Exide', 95, 'Robert', 100);
            await assetTransfer.CreateAsset(transactionContext, 'asset2', 'Amara', 90, 'Paul', 200);
            await assetTransfer.CreateAsset(transactionContext, 'asset3', 'Exide', 95, 'Troy', 300);
            await assetTransfer.CreateAsset(transactionContext, 'asset4', 'Amara', 90, 'Van', 400);
            ...
            let expected = [
                {Record: {ID: 'asset1', Manufacturer: 'Exide', SOH: 95, Owner: 'Robert', AppraisedValue: 100}},
                {Record: {ID: 'asset2', Manufacturer: 'Amara', SOH: 90, Owner: 'Paul', AppraisedValue: 200}},
                {Record: {ID: 'asset3', Manufacturer: 'Exide', SOH: 95, Owner: 'Troy', AppraisedValue: 300}},
                {Record: {ID: 'asset4', Manufacturer: 'Amara', SOH: 90, Owner: 'Van', AppraisedValue: 400}}
            ];
        ...
        it('should return success on GetAllAssets for non JSON value', async () => {
            ...
            let expected = [
                ...
                {Record: {ID: 'asset2', Manufacturer: 'Amara', SOH: 10, Owner: 'Paul', AppraisedValue: 200}},
                {Record: {ID: 'asset3', Manufacturer: 'Exide', SOH: 15, Owner: 'Troy', AppraisedValue: 300}},
                {Record: {ID: 'asset4', Manufacturer: 'Amara', SOH: 20, Owner: 'Van', AppraisedValue: 400}}
            ];
