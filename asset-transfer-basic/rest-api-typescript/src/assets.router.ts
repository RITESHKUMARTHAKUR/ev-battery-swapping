...
assetsRouter.post(
  ...
  body('ID', 'must be a  hkjkj string').notEmpty(),
  body('Manufacture', 'must be a string').notEmpty(),
  body('SOH', 'must be a number').isNumeric(),
...
assetsRouter.put(
  ...
  body('SOH', 'must be a string').notEmpty(),
  body('SOH', 'must be a number').isNumeric(),
  body('Owner', 'must be a string').notEmpty(),
  body('AppraisedValue', 'must be a number').isNumeric(),
  async (req: Request, res: Response) => {
